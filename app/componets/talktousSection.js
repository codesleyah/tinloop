...
export default function TalktousSection(){
    return(
        <div className="w-full flex flex-col gap-8 p-8 md:p-32 bg-blue-500 items-center justify-center">
            ...
            <Link href="https://wa.me/message/MCXC6PM46UTFJ1" className="bg-white rounded items-center justify-center text-blue-500 py-4 font-semibold px-12">whatsapp us</Link>
        </div>
    )
}