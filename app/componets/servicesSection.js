...
export default function ServicesSection(){
    return(
        <div className="p-32 grid grid-cols-2 gap-4 bg-gray-300 text-black">
            <div className="flex flex-col gap-2 items-center justify-center relative bg-black">
                ...
                <div className="bg-black opacity-75 p-2 absolute bottom-0 text-white">
                    <h1 className="font-semibold">Education &  Research</h1>
            ...
            <div className="flex flex-col gap-2 items-center justify-center relative">
                ...
                <div className="bg-black opacity-75 p-2 absolute bottom-0 text-white">
                    <h1 className="font-semibold">Medical Failities</h1>
            ...
            <div className="flex flex-col gap-2 items-center justify-center relative">
                ...
                <div className="bg-black opacity-75 p-2 absolute bottom-0 text-white">
                    <h1 className="font-semibold">Mining</h1>
                    <p className="text-sm">we have all the chemicals required
            ...
            <div className="flex flex-col gap-2 items-center justify-center relative">
                ...
                <div className="bg-black opacity-75 p-2 absolute bottom-0 text-white">
                    ...
                    <p className="text-sm">we supply chemicals, lab equipment 
